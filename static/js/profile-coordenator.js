...
async function editProfile() {
    ...
    const getProfileRequest = await fetch("/coordenator");
...
async function updateProfile() {
    ...
    if (!completeNameField.value || !emailField.value || !telField.value || !usercompleteNameField.value) {
    ...
    const updateProfileRequest = await fetch("/coordenator/update", {
        method: "POST",
